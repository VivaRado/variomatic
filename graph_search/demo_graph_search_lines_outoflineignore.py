...
def do_rule_check(inst_num,t_coords,t_contents,l_t, _f_pip):
	...
	for x in t_contents:
		...
		# print('========================================')
		# print('========================================')
		# pprint.pprint(_f_pip[ni]["agreed"])
		# print('========================================')
		# print('========================================')
		# print('========================================')
		# print('========================================')
		...
		for k,v in _f_pip[ni]["agreed"].items():
			...
			for y in v[1:]:
				...
				# 			print([u[1],u[2], u[3]])
				# 			#
				# 			print("ignoring", z_num)
				# 			#
				# 			#
				# 			ignore_num.add(z_num)
				# 			#
				# 		#
				# 		#
				# 	#
...
def do_line_check(_a_instance, _b_instance, l_s, l_t, ms_pn_s, mt_pn_s, scp_s, scp_t, _f):
	...
	for x in iter_line:
		...
		#
		print("===============>", x)
		get_agreed(inx_m, iter_agg_a, iter_agg_b, iter_a, iter_b)
		#
		# print('==========')
		# print(_a_ag)
		# print('===')
...
def get_point_line(coords, _c, _f, inum):
	...
	# for _x in scp:
	# 		#
	# 	for k,v in _f.m_instances[inum]["agreed"].items():
	# 		#
	# 		for x in v[1:]:
	# 			#pass
	# 			#for _x in scp:
	...
	# 				#
	# 			#
				#is_match_a = [s for s in x if _x == s[3]]
				#
				#print(_x,"===>>>")
				#print(is_match_a)
		#
	# for _k,_v in _f.m_instances[ni]["agreed"].items():
	# 	#
	# 	for y in _v[1:]:
	# 		#pass
	# 		for _y in scp:
				
	# 			is_match_b = [s for s in x if _y == s[3]]
	# 			#
	# 			print(_y,"===<<<")
	# 			print(is_match_b)
			#
	...
	if len(list(points_b.items())) > iter_point:
		...
		for k,v in points_b.items():
			...
			if k!=(0,0):
				...
				#
				#
				max_radius = 200 # compute max radius from thegeneral distances average
				#
		...
		if _plt:
			...
			#if len(scp_s[0]) == 1: # there is no line 9999
				#
			#rule_check_exists_better = do_rule_check(_b_instance["inst"],_b_instance["coords"]["strt"], mt_pn_s, l_t, _f.m_instances) # rule check over existing agreed generated by the initial graph searches.
				#
			
			#rule_check_not_on_line = do_rule_not_on_line( mt_pn_s, l_t) # rule check over existing agreed generated by the initial graph searches.
