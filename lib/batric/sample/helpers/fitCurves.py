...
def remove_same_line(points):
    #
    rdp_points = rdp(points,epsilon=1)
...
def fitCubic(points, leftTangent, rightTangent, error):
    ...
    rightTangent = 0
    #
    points = remove_same_line(points)
    #
...
def generateBezier(points, parameters, leftTangent, rightTangent):
    ...
    for i, u in enumerate(parameters):
        A[i][0] = 0#leftTangent  * 3*(1-u)**2 * u
        A[i][1] = 0#rightTangent * 3*(1-u)    * u**2
